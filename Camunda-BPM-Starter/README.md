...
<!-- HTML snippet for index page
  <tr>
    <td><img src="snippets/Camunda-BPM-Starter/src/main/resources/process.png" width="100"></td>
    <td><a href="snippets/Camunda-BPM-Starter">Camunda BPM Process Application</a></td>
